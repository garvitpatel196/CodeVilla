...
<html>
    <head>
        <%
            ...
            String str = "select Phone_Number from login where User_Name='" + un + "' ";
            String mob = null;
            ...
            while (rs.next()) {
                ...
                c = 1;
                mob = rs.getString("Phone_Number");
            }
            String sub = mob.substring(7);
    ...
    <body>
        ...
        <div class="container-fluid" style="padding-top:70px;overflow-x: hidden;padding-left: 0px;padding-right: 0px;">
            ...
            <div class="row edi" style="margin-bottom: 90px" >

                <div style="margin-left: 12%;margin-right: 10%;width:85%">

                    <div class="row" style="clear: left">
                        <div class="col-sm-11 editor">
                            <h3>Please Enter Your Mobile-Number to Verify :</h3>
                            <%            out.print("********" + sub);
                            %>
                            <form class="form" action="check" method="get"> 
                                <input class="form-control" placeholder="Enter Phone-Number" type="text" name="mn" style="width: 40%" required><br>
                                <button class="btn btn-info" style="float: left;margin-top: 5px;width: 20%" type="submit">Login</button>
                            </form>
                        </div>
                    </div>
                </div>
