...
//                
    ...
    <body onload="sess()">
        ...
        <div class="container-fluid" style="padding-top:70px;overflow-x: hidden;padding-left: 0px;padding-right: 0px;">
            ...
            <%                quer = "select * from eventqus where Qus_Name='Factorial';";
                String ques_name = "";
                String ques_desc = "";
                String ques_input = "";
                String ques_output = "";
                ...
                while (rs.next()) {
                    ques_name = rs.getString("Qus_Name");
                    ques_desc = rs.getString("Ques_Desc");
                    ques_input = rs.getString("sample_input");
                    ques_output = rs.getString("sample_output");
                ...
                <div style="margin-left: 12%;margin-right: 10%;width:85%">
                    ...
                    <div class="row" style="clear: left">
                        ...
                        <div class="col-sm-11 editor">
                            ...
                            <div class="pan-body" style="color:black!important">
                                <div>
                                    <div class="row" style="font-weight: bold;color:black!important">
                                        Description
                                    </div>

                                    <div id="ques_desc" class="row" style="color:black!important">
                                        <% out.print(ques_desc);%>
                                    </div>
                                    ...
                                    <div class="row" style="color:black!important">
                                        For each test case print the factorial of a number.
                                    </div>
                                    <div class="row" style="font-weight: bold;color:black!important">
                                        Constraints:
                                    </div>
        ...
        <div class="container-fluid" style="overflow-x: hidden;padding-left: 0px;padding-right: 0px;">
            <div class="row edi">
                ...
                <form name="vinform" method="GET" style="float:right;width: 90%;">
                    ...
                    <div class="row" style="clear: left;margin-left: 0.5%;margin-right: -8%;">
